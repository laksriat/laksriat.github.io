...
const nav_routes = ["/laksri/#", "/laksri/products.html", "/laksri/#contact", "/laksri/#about"];
const routes = ["/laksri/", "/laksri/products.html"];
const hashes = {
	"/laksri/": ["", "#contact", "#about"] // Hashes for index/home page
};
	...
	if (body != undefined) {
		...
		<div id="header-body" class="hidden">
			...
			<div id="mySidenav" class="sidenav">
				...
				<a href="/laksri/#contact">Contact Us</a>
				<a href="/laksri/#about">About</a>
			</div>
